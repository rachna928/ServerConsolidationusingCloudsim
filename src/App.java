...
public class App {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Vm vm1 = new Vm(vmid+1, brokerId, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
...
cloudlet1.setVmId(vmid+1);
		...
		//	broker.submitHostList(hostList);
			...
			PowerVmAllocationPolicyMigrationAbstract fallbackVmSelectionPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
					...
					0.7);
			double parameter = 0;
			VmAllocationPolicy vmAllocationPolicy = new PowerVmAllocationPolicyMigrationLocalRegression(
					hostList,
					vmSelectionPolicy,
					parameter,
			...
			vmAllocationPolicy.getHostList().size();
			
			//vmAllocationPolicy.optimizeAllocation()
			Log.printLine("CloudSimExample1 finished!"+vmAllocationPolicy.getHostList().size());
